...
namespace Group_choice_algos_fuzzy
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox_Linear_medians = new System.Windows.Forms.GroupBox();
			this.dg_Linear_medians = new System.Windows.Forms.DataGridView();
			...
			this.cb_Linear_medians = new System.Windows.Forms.CheckBox();
			...
			this.groupBox_Linear_medians.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.dg_Linear_medians)).BeginInit();
			...
			this.groupBox_HP_max_length.Text = "Гамильтоновы пути максимальной длины";
			// 
			// dg_HP_max_length
			// 
			...
			this.dg_HP_max_length.DefaultCellStyle = dataGridViewCellStyle6;
			...
			this.dg_HP_max_strength.DefaultCellStyle = dataGridViewCellStyle7;
			...
			this.dg_Schulze_method.DefaultCellStyle = dataGridViewCellStyle8;
			...
			// 
			// groupBox_Linear_medians
			// 
			this.groupBox_Linear_medians.Controls.Add(this.dg_Linear_medians);
			this.groupBox_Linear_medians.Location = new System.Drawing.Point(3, 771);
			this.groupBox_Linear_medians.MaximumSize = new System.Drawing.Size(1000, 500);
			this.groupBox_Linear_medians.MinimumSize = new System.Drawing.Size(10, 10);
			this.groupBox_Linear_medians.Name = "groupBox_Linear_medians";
			this.groupBox_Linear_medians.Size = new System.Drawing.Size(450, 250);
			this.groupBox_Linear_medians.TabIndex = 22;
			this.groupBox_Linear_medians.TabStop = false;
			this.groupBox_Linear_medians.Text = "Линейные медианы";
			// 
			// dg_Linear_medians
			// 
			this.dg_Linear_medians.AllowUserToAddRows = false;
			this.dg_Linear_medians.AllowUserToDeleteRows = false;
			this.dg_Linear_medians.AutoSizeColumnsMode = System.Windows.Forms.DataGridViewAutoSizeColumnsMode.AllCells;
			this.dg_Linear_medians.AutoSizeRowsMode = System.Windows.Forms.DataGridViewAutoSizeRowsMode.AllCells;
			this.dg_Linear_medians.ClipboardCopyMode = System.Windows.Forms.DataGridViewClipboardCopyMode.EnableWithoutHeaderText;
			this.dg_Linear_medians.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			...
			this.dg_Linear_medians.DefaultCellStyle = dataGridViewCellStyle9;
			this.dg_Linear_medians.Dock = System.Windows.Forms.DockStyle.Fill;
			this.dg_Linear_medians.Location = new System.Drawing.Point(3, 16);
			this.dg_Linear_medians.MinimumSize = new System.Drawing.Size(100, 100);
			this.dg_Linear_medians.Name = "dg_Linear_medians";
			this.dg_Linear_medians.ReadOnly = true;
			this.dg_Linear_medians.RowHeadersWidth = 100;
			this.dg_Linear_medians.ShowEditingIcon = false;
			this.dg_Linear_medians.Size = new System.Drawing.Size(444, 231);
			this.dg_Linear_medians.TabIndex = 1;
			// 
			// groupBox_All_rankings
			// 
			this.groupBox_All_rankings.Controls.Add(this.dg_All_rankings);
			this.groupBox_All_rankings.Location = new System.Drawing.Point(3, 1027);
			...
			this.dg_All_rankings.DefaultCellStyle = dataGridViewCellStyle10;
			...
			this.groupBox4.Controls.Add(this.cb_Linear_medians);
			...
			this.groupBox4.Location = new System.Drawing.Point(183, 58);
			this.groupBox4.Name = "groupBox4";
			this.groupBox4.Size = new System.Drawing.Size(249, 104);
			...
			this.cb_All_rankings.Location = new System.Drawing.Point(3, 84);
			this.cb_All_rankings.Name = "cb_All_rankings";
			this.cb_All_rankings.Size = new System.Drawing.Size(243, 17);
			...
			// cb_Linear_medians
			// 
			this.cb_Linear_medians.AutoEllipsis = true;
			this.cb_Linear_medians.Dock = System.Windows.Forms.DockStyle.Top;
			this.cb_Linear_medians.Location = new System.Drawing.Point(3, 67);
			this.cb_Linear_medians.Name = "cb_Linear_medians";
			this.cb_Linear_medians.Size = new System.Drawing.Size(243, 17);
			this.cb_Linear_medians.TabIndex = 3;
			this.cb_Linear_medians.Text = "Линейные медианы";
			this.cb_Linear_medians.UseVisualStyleBackColor = true;
			// 
			// cb_Schulze_method
			// 
			...
			this.cb_Schulze_method.Size = new System.Drawing.Size(243, 17);
			...
			this.cb_HP_max_strength.Size = new System.Drawing.Size(243, 17);
			...
			this.cb_HP_max_length.Size = new System.Drawing.Size(243, 17);
			this.cb_HP_max_length.TabIndex = 0;
			this.cb_HP_max_length.Text = "Гамильтоновы пути максимальной длины";
			...
			this.textBox_file.Size = new System.Drawing.Size(277, 20);
			...
			this.button_file.Location = new System.Drawing.Point(281, 16);
			this.button_file.Name = "button_file";
			this.button_file.Size = new System.Drawing.Size(92, 22);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.button_n_m.Location = new System.Drawing.Point(9, 62);
			...
			this.groupBox_Linear_medians.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.dg_Linear_medians)).EndInit();
		...
		private System.Windows.Forms.CheckBox cb_Linear_medians;
		...
		private System.Windows.Forms.GroupBox groupBox_Linear_medians;
