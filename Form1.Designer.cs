...
namespace Group_choice_algos_fuzzy
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.groupBox_HP_max_length.AutoSize = true;
			this.groupBox_HP_max_length.AutoSizeMode = System.Windows.Forms.AutoSizeMode.GrowAndShrink;
			...
			this.groupBox_HP_max_length.Size = new System.Drawing.Size(400, 66);
			...
			this.dg_HP.RowHeadersWidthChanged += new System.EventHandler(this.dg_All_rankings_RowHeadersWidthChanged);
			this.dg_HP.RowHeightChanged += new System.Windows.Forms.DataGridViewRowEventHandler(this.dg_RowHeightChanged);
			// 
			// groupBox_Schulze_method
			// 
			this.groupBox_Schulze_method.AutoSize = true;
			this.groupBox_Schulze_method.AutoSizeMode = System.Windows.Forms.AutoSizeMode.GrowAndShrink;
			this.groupBox_Schulze_method.Controls.Add(this.dg_Schulze_method);
			this.groupBox_Schulze_method.Location = new System.Drawing.Point(3, 75);
			...
			this.groupBox_Schulze_method.Size = new System.Drawing.Size(400, 66);
			...
			this.dg_Schulze_method.RowHeadersWidthChanged += new System.EventHandler(this.dg_All_rankings_RowHeadersWidthChanged);
			this.dg_Schulze_method.RowHeightChanged += new System.Windows.Forms.DataGridViewRowEventHandler(this.dg_RowHeightChanged);
			// 
			// groupBox_All_rankings
			// 
			this.groupBox_All_rankings.AutoSize = true;
			this.groupBox_All_rankings.AutoSizeMode = System.Windows.Forms.AutoSizeMode.GrowAndShrink;
			this.groupBox_All_rankings.Controls.Add(this.dg_All_rankings);
			this.groupBox_All_rankings.Location = new System.Drawing.Point(3, 147);
			...
			this.groupBox_All_rankings.Size = new System.Drawing.Size(400, 66);
			...
			this.dg_All_rankings.RowHeadersWidthChanged += new System.EventHandler(this.dg_All_rankings_RowHeadersWidthChanged);
			this.dg_All_rankings.RowHeightChanged += new System.Windows.Forms.DataGridViewRowEventHandler(this.dg_RowHeightChanged);
			// 
			// groupBox_SY
			// 
			this.groupBox_SY.AutoSize = true;
			this.groupBox_SY.AutoSizeMode = System.Windows.Forms.AutoSizeMode.GrowAndShrink;
			this.groupBox_SY.Controls.Add(this.dg_SY);
			this.groupBox_SY.Location = new System.Drawing.Point(3, 219);
			this.groupBox_SY.MinimumSize = new System.Drawing.Size(400, 50);
			this.groupBox_SY.Name = "groupBox_SY";
			this.groupBox_SY.Size = new System.Drawing.Size(400, 66);
			...
			this.flowLayoutPanel_output_tables.PerformLayout();
